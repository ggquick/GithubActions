[![Run App GregoryQuick](https://github.com/ggquick/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/ggquick/GithubActions/actions/workflows/run-app.yaml)
